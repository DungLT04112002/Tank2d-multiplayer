...
public class Sound {
    ...
    public Sound(){
        ...
        soundURL[4] = getClass().getResource("../Assets/Sounds/pha_huy.wav");// 
        soundURL[5] = getClass().getResource("../Assets/Sounds/tieng tank ban.wav");
        soundURL[6] = getClass().getResource("../Assets/Sounds/tieng_phao.wav");
