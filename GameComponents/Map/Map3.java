...
public class Map3 {
    ...
    public Map3(GamePanel gamePanel) {
...
//
        for(int i=0;i<2;i++)
        {
            objectManager.createObject("HWall", 64*4+i*45, 64*3);
            objectManager.createObject("HWall", 64*4+i*45, 64*8);
            objectManager.createObject("HWall", 64*16+45*i, 64*3);
            objectManager.createObject("HWall", 64*16+45*i, 64*8);
        }
